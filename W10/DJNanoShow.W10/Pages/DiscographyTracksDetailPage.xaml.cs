//---------------------------------------------------------------------------
//
// <copyright file="DiscographyTracksDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class DiscographyTracksDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public DiscographyTracksDetailPage()
        {
            this.ViewModel = DetailViewModel.CreateNew(Singleton<DiscographyTracksConfig>.Instance);
