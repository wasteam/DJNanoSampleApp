//---------------------------------------------------------------------------
//
// <copyright file="ToursDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class ToursDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public ToursDetailPage()
        {
            this.ViewModel = DetailViewModel.CreateNew(Singleton<ToursConfig>.Instance);
