//---------------------------------------------------------------------------
//
// <copyright file="VideosDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class VideosDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public VideosDetailPage()
        {
            this.ViewModel = DetailViewModel.CreateNew(Singleton<VideosConfig>.Instance);
